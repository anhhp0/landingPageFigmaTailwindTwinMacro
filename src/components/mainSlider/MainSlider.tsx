    ...
    <div tw="flex flex-wrap flex-col md:flex-row ">
      ...
      <div tw="[width: 50%] grid grid-rows-3 pl-8">
        ...
        <div tw="text-base text-[#091156] [font-weight: 500]">
          It is a long established fact that a reader will be <br/> by the readable
          content of a page.
        </div>
        <div><PinkButton variant='moreDetailSlider'>More Details</PinkButton></div>
      </div>
      {/* Title and Desc  */}
      <div><AnimationSlider/></div>
    </div>
